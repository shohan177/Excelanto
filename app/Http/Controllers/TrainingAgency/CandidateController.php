...
{
    public function new(){
        $offeredCandidates = OfferedCandidate::where('post_training_status', 'New')->where('result_status', 'Post-Processing')->where('post_training_id', Auth::user()->id )->orderBy('id','DESC')->get();
