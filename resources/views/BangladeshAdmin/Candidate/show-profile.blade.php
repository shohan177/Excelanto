                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="timeline"> <strong><i
                                    ...
                                    <hr>
                                    @if($candidate->post_medical_report)
                                        <a href="{{ asset($candidate->post_medical_report) }}" target="_blank">
                                            <strong><i class="fa fa-file mr-1"></i> Pre-Medical Certificate</strong>
                                        </a>
                                        <div class="mailbox-attachment-info">
                                            <a href="{{ asset($candidate->post_medical_report) }}" download class="btn btn-default btn-xs float-right"><i class="fa fa-cloud-download"></i></a>
                                        </div>
                                    @else
