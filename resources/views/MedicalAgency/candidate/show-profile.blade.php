                    ...
                    <div class="panel panel-secondary card-outline">
                        ...
                        <div class="panel-body box-profile">
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Status</b> <span
                                        class="float-right badge badge-info">{{ $candidate->post_medical_status }}</span>
                                </li>
                            </ul>
                        </div>
                        <!-- /.panel-body -->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="timeline"> <strong><i
                                    ...
                                    <div class="mailbox-attachment-info">
                                        <a href="../pre_medical_certificate/{{ $candidate->post_medical_report }}" class="mailbox-attachment-name">
                                            <i class="fa fa-file"></i>
                                            {{ $candidate->post_medical_report }}
                                        </a>
                                        <a href="../pre_medical_certificate/{{ $candidate->post_medical_report }}" download class="btn btn-default btn-xs float-right">
