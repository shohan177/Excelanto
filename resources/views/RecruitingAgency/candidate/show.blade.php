                  ...
                  <div class="panel panel-secondary card-outline">
                    ...
                    <div class="panel-body box-profile">
                      <div class="text-center">
                        <img height="100px;" width="100px;" class="profile-user-img img-fluid img-circle" src="{{ asset($candidate->candidate_picture) }}" alt="User Image">
                      </div>
                      ...
                      <ul class="list-group list-group-unbordered mb-3">
                        ...
                        <li class="list-group-item">
                          <b>Status</b> <span class="float-right badge badge-info">{{ $candidate->active_status}}</span>
                        </li>
                      </ul>
                  ...
                  <div class="panel panel-secondary">
                    ...
                    <div class="panel-body">
                      ...
                      <div class="mailbox-attachment-info">
                        <a href="../pre_medical_certificate/{{ $candidate->pre_medical_certificate}}" class="mailbox-attachment-name"><i class="fa fa-file"></i> {{ $candidate->pre_medical_certificate}}</a>

                        <a href="../pre_medical_certificate/{{ $candidate->pre_medical_certificate}}" download class="btn btn-default btn-sm float-right"> <i class="fa fa-cloud-download-alt"></i></a>
                      ...
                      <div class="mailbox-attachment-info">
                        <a href="../pre_training_certificate/{{ $candidate->pre_training_certificate}}" class="mailbox-attachment-name"><i class="fa fa-file"></i> {{ $candidate->pre_training_certificate}}</a>

                        <a href="../pre_training_certificate/{{ $candidate->pre_training_certificate}}" download class="btn btn-default btn-sm float-right"> <i class="fa fa-cloud-download-alt"></i></a>
