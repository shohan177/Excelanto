    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a {{Request::is('SuperAdmin.role.*') ? 'active': ''}} href="{{ route('SuperAdmin.role.index') }}" class="waves-effect"><i class="mdi mdi-account-key"></i> <span> Role's </span> <span class="pull-right"><i class="mdi mdi-plus"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href=""><i class="fa fa-arrow-circle-right"></i> All Role</a></li>
                    </ul>
                </li>
