                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                                    ...
                                    <p class="text-muted">Travel agencies should submit their quotations(ticket cost for the journey of given total) before the enquiry end date. To send your quotation, click Apply and fill in the details.</p>
                                    <br>
