                                                ...
                                                <div class="panel-body user-card">
                                                    <div class="media-main">
                                                        <div class="info">
                                                            ...
                                                            <p class="text-muted">{{ $submittedTravelEnquiry->travelEnquiry->start_point }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div> <!-- panel-body -->
                                            ...
                                            <div class="panel">
                                                <div class="panel-body user-card">
                                                    <div class="media-main">
                                                        <div class="info">
                                                            <h4>End point(To)</h4>
                                                            <p class="text-muted">{{ $submittedTravelEnquiry->travelEnquiry->end_point }}</p>
                                                        </div>
                                                    </div>
                                                </div> <!-- panel-body -->
                                            </div>
                                                ...
                                                <div class="panel-body user-card">
                                                    <div class="media-main">
                                                        <div class="info">
                                                            ...
                                                            <p class="text-muted">
                                                                {{ $submittedTravelEnquiry->travelEnquiry->tickets_required }}</p>
                                                        </div>
                                                    </div>
                                                </div> <!-- panel-body -->
                                            </div>
                                            ...
                                            <div class="post">
                                                <div class="user-block">
                                                    @if ($submittedTravelEnquiry->travelEnquiry->oss->logo)
                                                        <img height="100px;" width="100px;" src="{{ asset($submittedTravelEnquiry->travelEnquiry->oss->logo) }}"
                                                    ...
                                                    <span class="username">
                                                        <a
                                                            href="{{ route('OneStopService.company.showCompanyProfile', $submittedTravelEnquiry->travelEnquiry->oss->id) }}">{{ $submittedTravelEnquiry->travelEnquiry->oss->company_name }}
                                                            ({{ $submittedTravelEnquiry->travelEnquiry->oss->username }})</a>
                                                    </span>
                                                    <hr>
                                                    @if ($submittedTravelEnquiry->travelAgency->logo)
                                                        <img height="100px;" width="100px;" src="{{ asset($submittedTravelEnquiry->travelAgency->logo) }}"
                                                            class="profile-user-img img-fluid img-circle"
                                                            alt="User Image" />
                                                    @else
                                                        <img class="profile-user-img img-fluid img-circle" height="70px;"
                                                    ...
                                                    <span class="username">
                                                        <a
                                                            href="{{ route('OneStopService.company.showCompanyProfile', $submittedTravelEnquiry->travelAgency->id) }}">{{ $submittedTravelEnquiry->travelAgency->company_name }}
                                ...
                                <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
                                    ...
                                    <div class="text-muted">
                                        <p class="text-sm">Date of journey<br>
                                            <b class="d-block">{{ $submittedTravelEnquiry->travelEnquiry->date_of_journey }}</b><br>
                                        </p>
                                        <p class="text-sm">Enquiry end date<br>
                                            <b class="d-block">{{ $submittedTravelEnquiry->travelEnquiry->end_date }}</b><br>
                                        </p>
                                        <p class="text-sm">Total Tickets Cost<br>
                                            <b class="d-block">{{ $submittedTravelEnquiry->submitted_cost }}</b><br>
                                        </p>
                                    </div>
