                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="companyRegisterNumber"
                                                        readonly value="{{ $user->company_register_number }}" type="text"
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                            <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea readonly class="form-control" name="address1" id="address1" cols="30"
                                                        rows="3">{{ $user->address1 }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="address2">Address 2</label>
                                                    <textarea readonly class="form-control" name="address2" id="address2" cols="30"
                                                        rows="3">{{ $user->address2 }}</textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="activeStatus">Select Eeither Approve Or Reject the Company Profile</label>
                                                    <select class="form-control" name="activeStatus" id="activeStatus">
                                                        <option value="">Select Status</option>
                                                        <option  @if($user->active_status === "Approved") selected  @endif value="Approved">Approved</option>
                                                        <option @if($user->active_status === "Rejected") selected  @endif value="Rejected">Rejected</option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
