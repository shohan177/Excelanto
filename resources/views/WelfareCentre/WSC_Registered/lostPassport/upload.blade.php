    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="panel panel-warning">
                        ...
                        <div class="panel-body p-5">
                                <dl class="row">
                                    ...
                                    <dd class="col-sm-6">{{ $lostPassportService->candidate->candidate_name }}</dd>
                                    <br>
                                    <dt class="col-sm-6">CPR</dt>
                                    <dd class="col-sm-6">{{ $lostPassportService->cpr }}</dd><br>
                                    <dt class="col-sm-6">Salary</dt>
                                    <dd class="col-sm-6">{{ $lostPassportService->salary_type }}</dd><br>
                                    <dt class="col-sm-6">Service Status</dt>
                                    <dd class="col-sm-6">{{ $lostPassportService->service_status }}</dd><br>
                ...
                <div class="col-lg-6">
                    <form action="{{ route('WelfareCentre.lostPassport.update', $lostPassportService->id) }}" method="post"
