    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <dl class="row">
                                        ...
                                        <dd class="col-sm-7">{{ $meetAndGreet->service_name }}</dd>
                                        <dt class="col-sm-5">Date of arrival/departure</dt>
                                        <dd class="col-sm-7">{{ $meetAndGreet->arrival_date }}</dd>
                                        <dt class="col-sm-5">Name of the airlines</dt>
                                        <dd class="col-sm-7">{{ $meetAndGreet->airline_name }}</dd>
                                        <dt class="col-sm-5">Flight number</dt>
                                        <dd class="col-sm-7">{{ $meetAndGreet->flight_number }}</dd>
                                        <dt class="col-sm-5">Flight time</dt>
                                        <dd class="col-sm-7">{{ $meetAndGreet->flight_time }}</dd>
                                        <dt class="col-sm-5">Guest passport</dt>
                                        <dd class="col-sm-7"><a href="#" target="_blank" class="btn btn-outline-warning btn-xs"><b>View</b></a></dd>
                                    </dl>
                                </div>
                                <div class="col-md-6">
                                    <dl class="row">
                                        <dt class="col-sm-4">Name of the guest</dt>
                                        <dd class="col-sm-8">{{ $meetAndGreet->guest_name }}</dd>
                                        <dt class="col-sm-4">Number of guests</dt>
                                        <dd class="col-sm-8">{{ $meetAndGreet->number_of_guests }}</dd>
                                        <dt class="col-sm-4">Transport services</dt>
                                        <dd class="col-sm-8">{{ $meetAndGreet->transport_service }}</dd>
                                        <dt class="col-sm-4">Message</dt>
                                        <dd class="col-sm-8">{{ $meetAndGreet->comments }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('WelfareCentre.meetGreetStatusUpdete', $meetAndGreet->id) }}"
